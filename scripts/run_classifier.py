...
parser.add_argument("--neural_model", type=str, choices=[None, "classic", "lstm"], default=None, help="Select type of NeuralModel to classify with")
parser.add_argument("--device", type=str, default="cuda", help="Select GPU device")
parser.add_argument("--num_trials", type=int, default=5, help="Specify number of trials")
parser.add_argument("--num_instances", type=int, default=1, help="Specify number of instances")
parser.add_argument("--metric", type=str, choices=["f1","acc","auc"], default="auc", help="Select metric to optimize")
parser.add_argument("--direction", type=str, choices=["maximize","minimize"], default="maximize", help="Select direction for the optimization")
parser.add_argument("--algo", type=str, choices=["TPE","RND","GRID"], default="GRID", help="Select parameter search algorithm")
parser.add_argument("--fix", nargs='+', default=[], help="Specify fixed feature components")
parser.add_argument("--exclude", nargs='+', default=[], help="Specify excluded feature components")
parser.add_argument("--parameters", type=str, default=None, help="Specify path for parameters.json to set the search space")
parser.add_argument("--experiment_folder", type=str, default=None, help="Specify experiment folder name")
...
# tune parameters
best_config = clf.tune(parameters, args.algo, args.num_trials, args.metric, args.direction, args.num_instances, args.comet_workspace, args.comet_project, export_dir=export_dir)